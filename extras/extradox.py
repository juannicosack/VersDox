...
def google():
	...
	nom = input(Fore.RED + "  [root@VersDox " + Fore.CYAN + "Introduzca datos: " + Fore.WHITE)
...
def SearchEmail():
	print()
	email = input(Fore.RED + "  [root@VersDox " + Fore.CYAN + "Introduce un correo: " + Fore.WHITE)
...
def searchUserName():
	print()
	username = input(Fore.RED + "  [root@VersDox] " + Fore.CYAN + " Introduce un nick: " + Fore.WHITE)
...
print()
print(Fore.YELLOW + " " * 2 + " Versdox/extradox")
print(menu)
try:
	while True:
		parametros = input(Fore.MAGENTA + "  [root@VersDox] ═> " + Fore.WHITE)
		if parametros == "1":
			SearchEmail()
		elif parametros == "2":
			searchUserName()
			...
			print()
			try:
				target = input(Fore.RED + "  [root@VersDox] " + Fore.CYAN + " Introduce una ip: " + Fore.WHITE)
			...
			print()
			user = input(Fore.RED + "  [root@VersDox] " + Fore.CYAN + "Introduce un nick de minecraft: " + Fore.WHITE)
			nick = user.lower()
	...
	print(Fore.RED + "\n\n  [root@VersDox]" + Fore.GREEN + " Saliendo de la tool..." + Fore.WHITE)
	time.sleep(1.5)
except:
	pass
